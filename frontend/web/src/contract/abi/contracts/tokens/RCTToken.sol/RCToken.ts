...
export type RCTokenEvents =
  ...
  | 'Unpaused'
  | 'Upgraded';
export interface RCTokenEventsContext {
...
export type RCTokenMethodNames =
  | 'new'
  | 'DEFAULT_ADMIN_ROLE'
  | 'MINTER_ROLE'
  | 'PAUSER_ROLE'
...
export interface RCToken {
   ...
   * Type: function
   */
  UPGRADER_ROLE(overrides?: ContractCallOverrides): Promise<string>;
  /**
   * Payable: false
   * Constant: true
   * StateMutability: view
